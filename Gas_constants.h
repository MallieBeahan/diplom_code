...
double V0 = 0.0;
//Коэффициент сжимаемости по первой формуле
double Z1 = 0.0;
//Коэффициент сжимаемости по второй формуле
double Z2 = 0.0;
//Коэффициент сжимаемости по третьей формуле
double Z3 = 0.0;
//Коэффициент сжимаемости по четвертой формуле
double Z4 = 0.0;
//Универсальная газовая постоянная
double R = 8.31 * pow(10,23);
