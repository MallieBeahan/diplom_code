...
void MD()//Основная функция расчетов МД
{
    for(int n=startingStep;n<NSTEPS;n++){
        ...
        //Подсчета объема системы до применения баростата Берендсена, для расчета коэффициента сжимаемости.
        if(n!=startingStep){
        ...
        //Подсчет давления системы до применения баростата Берендсена, для вычисления коэффициента сжимаемости
